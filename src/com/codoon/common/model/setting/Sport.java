...
public class Sport {
    ...
    private static final String beatsText = "节拍器";
    private static final String runAfterText = "跑后拉伸";
    private static final String actionPreviewText = "动作预览";
    private static final String autoPauseText = "自动暂停";
    private static final String lightKeepText = "运动时保持屏幕常亮";
    ...
    private static final String codoonWalkshoeText = "咕咚智能健步鞋";
    private static final String linkBluemachineText = "连接蓝牙跑步机";

    private static final String distanceText = "距离";
    private static final String timeText = "时长";
    private static final String speedText = "配速";
    private static final String averageText = "平均速度";
    ...
    public static final String SETTING_VOICE_SPEED_ID = "com.codoon.gps:id/voice_premile_slip";
    public static final String SETTING_VOICE_AVG_ID = "com.codoon.gps:id/voice_speed_slip";

    public static final String SETTING_VOICE_PLAY_TEXT = "text(\""+voicePlayText+"\")";
...
//    public static final String SETTING_AUTO_LOCK_TEXT = "text(\""+autoLockText+"\")";
    ...
    public static final String SETTING_CODOON_WALKSHOE_TEXT = "text(\""+codoonWalkshoeText+"\")";
    public static final String SETTING_BLUE_MACHINE_TEXT = "text(\""+linkBluemachineText+"\")";

    public static final String SETTING_VOICE_DISTANCE_TEXT = "text(\""+distanceText+"\")";
    public static final String SETTING_VOICE_TIME_TEXT = "text(\""+timeText+"\")";
    public static final String SETTING_VOICE_SPEED_TEXT = "text(\""+speedText+"\")";
    public static final String SETTING_VOICE_AVERAGE_TEXT = "text(\""+averageText+"\")";
}
